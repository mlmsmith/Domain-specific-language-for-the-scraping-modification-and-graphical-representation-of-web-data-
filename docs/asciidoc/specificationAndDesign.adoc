...
The project was developed entirely in the Python version 3.9. Python was chosen due to its ease and speed of implementation, as well as versatility, making the integration between the compiling of the = Specification and design
...
The project was developed entirely in the Python version 3.9. Python was chosen due to its ease and speed of implementation, as well as versatility, making the integration between the compiling of the SDQL and passing of variables to the underlying framework more intuitive and less error-prone. It also hosts many of the most popular and highly regarded web scraping frameworks.
 and passing of variables to the underlying framework more intuitive and less error-prone. It also hosts many of the most popular and highly regarded web scraping frameworks.
